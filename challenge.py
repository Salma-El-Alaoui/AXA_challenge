...
#%%
df= date_to_str(df,["DATE"])
df_test['prediction']= pd.merge(df_test,df[['DATE','ASS_ASSIGNMENT', 'CSPL_RECEIVED_CALLS']], left_on = ['DATE_2012','ASS_ASSIGNMENT'],right_on = ['DATE','ASS_ASSIGNMENT'],how='inner')['CSPL_RECEIVED_CALLS']
